...
from backend import TinyYoloFeature, FullYoloFeature, MobileNetFeature, SqueezeNetFeature, Inception3Feature, VGG16Feature, ResNet50Feature, AssociationNet
...
class YOLO(object):
    def __init__(self, backend,
        ...
        if backend == 'Inception3':
            ...
            self.feature_extractor = AssociationNet(self.input_size)
        ...
        output = Conv2D(self.nb_box * (4 + 1 + self.nb_class), 
                        (1,1), strides=(1,1), 
                        padding='same', 
                        name='DetectionLayer',data_format="channels_last",
